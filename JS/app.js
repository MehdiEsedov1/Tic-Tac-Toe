...
function result_x() {
    ...
    winner_x.setAttribute("style", 'background-image: url("./images/Untitled design (22).png")');
    open_resultpage();
    point_selector = true;
    getPointToStorage();
...
function result_y() {
    ...
    winner_y.setAttribute("style", 'background-image: url("./images/Untitled design (23).png")');
    open_resultpage();
